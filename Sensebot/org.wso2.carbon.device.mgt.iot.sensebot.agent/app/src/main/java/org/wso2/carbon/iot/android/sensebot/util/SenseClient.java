...
public class SenseClient {
     ...
     * @return
     */
    public RegisterInfo register(String username, String password, android.os.Handler mUiHandler) {
        Map<String, String> response = registerWithTimeWait(username, password);
    ...
    public Map<String, String> registerWithTimeWait(String username, String password) {
        try {
            ...
            senseClientAsyncExecutor.execute(username, password, endpoint);
