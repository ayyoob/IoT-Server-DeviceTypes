...
package org.wso2.devicetype.sensebot.plugin.internal;
...
import org.wso2.devicetype.sensebot.plugin.impl.DeviceTypeManagerService;
...
/**
 * @scr.component name="org.wso2.devicetype.sensebot.plugin.internal.ServiceComponent"
 * immediate="true"
...
public class ServiceComponent {
    ...
    protected void setDeviceTypeConfigService(DeviceTypeConfigService deviceTypeConfigService) {
        DeviceTypeManagementDataHolder.getInstance().setDeviceTypeConfigService(deviceTypeConfigService);
    }

    protected void unsetDeviceTypeConfigService(DeviceTypeConfigService deviceTypeConfigService) {
        DeviceTypeManagementDataHolder.getInstance().setDeviceTypeConfigService(null);
    }
}
