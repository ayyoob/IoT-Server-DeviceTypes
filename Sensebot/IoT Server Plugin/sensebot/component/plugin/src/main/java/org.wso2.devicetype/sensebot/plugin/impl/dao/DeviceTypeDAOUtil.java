...
/**
 * Database handler which is specified for sensebot type
 */
public class DeviceTypeDAOUtil {

    private static final Log log = LogFactory.getLog(DeviceTypeDAOUtil.class);
    static DataSource dataSource;           // package local variable
    private static ThreadLocal<Connection> currentConnection = new ThreadLocal<>();

    public DeviceTypeDAOUtil() {
        initDeviceTypeDAO();
    }
