...
import org.wso2.devicetype.sensebot.api.dto.SensorRecord;
import org.wso2.devicetype.sensebot.api.util.APIUtil;
import org.wso2.devicetype.sensebot.api.util.ZipUtil;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public static final String DEFAULT_MQTT_ENDPOINT = "tcp://localhost:1883";
    ...
    @POST
    public Response changeDirection(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            String directionState = direction.toLowerCase();
            if (!directionState.equals(DeviceTypeConstants.FORWARD) && !directionState.equals(DeviceTypeConstants.REVERSE)
                    && !directionState.equals(DeviceTypeConstants.LEFT)
                    && !directionState.equals(DeviceTypeConstants.RIGHT)
                    && !directionState.equals(DeviceTypeConstants.STOP)) {
                log.error("The requested state change should be either - 'FORWARD, REVERSE, LEFT, RIGHT, STOP'");
            ...
            commandOp.setCode("direction");
            commandOp.setType(Operation.Type.COMMAND);
            commandOp.setEnabled(true);
            commandOp.setPayLoad(direction.toLowerCase());

            Properties props = new Properties();
            props.setProperty(DeviceTypeConstants.MQTT_ADAPTER_TOPIC_PROPERTY_NAME, publishTopic);
...
//            sensorTableName = DeviceTypeConstants.SENSOR_TYPE1_EVENT_TABLE;
    ...
    public Response getAllDevices() {
        try {
            ...
            ArrayList<String> sensebotDevices = new ArrayList<>();
            for (Device device : userDevices) {
                if (device.getType().equals(DeviceTypeConstants.DEVICE_TYPE) &&
                    ...
                    sensebotDevices.add(device.getDeviceIdentifier());
                }
            }
    ...
    public Response downloadSketch(@QueryParam("deviceName") String deviceName,
        ...
        try {
            ...
            response.header("Content-Length", String.valueOf(zipFile.getZipFile().length()));
    ...
    private ZipArchive createDownloadFile(String owner, String deviceName, String sketchType)
        ...
        String scopes = "cdmf/" + DeviceTypeConstants.DEVICE_TYPE + "/" + deviceId;
