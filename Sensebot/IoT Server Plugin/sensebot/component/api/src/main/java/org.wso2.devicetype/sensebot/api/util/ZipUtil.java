...
package org.wso2.devicetype.sensebot.api.util;
...
public class ZipUtil {
    ...
    public ZipArchive createZipFile(String owner, String tenantDomain, String deviceType,
        ...
        try {
            ...
            String mqttEndpoint = replaceMqttProperty(DEFAULT_MQTT_ENDPOINT);
    ...
    public static String replaceMqttProperty(String urlWithPlaceholders) {
        ...
        urlWithPlaceholders = org.wso2.carbon.core.util.Utils.replaceSystemProperty(urlWithPlaceholders);
